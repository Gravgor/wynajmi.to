...
export default function Footer({
  ...
  return (
    <footer className={cn(`w-screen bg-gray-900 text-white py-8 md:py-12 -mb-[50px] ${className}`)}>
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          {/* Logo i opis */}
          <div className="mb-6 md:mb-0 flex flex-col items-center md:items-start">
            <img src="/images/logo.png" alt="Wynajmi.to Logo" className="w-24 md:w-32 mb-4" />
          ...
          <div className="flex flex-col items-center">
            ...
            <form className="flex flex-col md:flex-row items-center">
              <input
                ...
                className="p-2 border border-gray-700 rounded-md mb-4 md:mb-0 md:mr-4 w-full md:w-64 focus:outline-none focus:ring-2 focus:ring-white"
              />
              <button
                type="submit"
                className="px-4 py-2 bg-white text-[#F59E0B] rounded-md font-semibold hover:bg-gray-200 transition"
              >
                Zapisz się
              </button>
            </form>
